...
| ⚡ **Real-Time Streaming Fraud Detection** | Kafka/Redpanda + Quix Streams + Redis online store — batch fraud model scoring a live stream. p99 **172ms @ 100 TPS**, replay-deterministic state, 4 documented war stories. | [GitHub](https://github.com/Fikri645/streaming-fraud-detection) |
